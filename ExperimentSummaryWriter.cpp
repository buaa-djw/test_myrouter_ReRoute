                            ...
                            double rt)
{
    ...
    int n_2d = 0, n_3d = 0;
    double ed_total_hbt = 0.0, ed_sum_hbt_3d = 0.0, ed_max_hbt_3d = 0.0;
    int ed_hbt_3d_n = 0;
    ...
    for (const auto& r : results) {
        ...
        if (r.delay_summary.ready && !r.delay_summary.single_pin_net) {
            if (r.is_3d) {
    ...
    o << "router_rc_hbt_res=" << cfg.rc.hbt_res * cfg.rc.hbt_rc_scale << "\n";
    o << "router_rc_hbt_cap=" << cfg.rc.hbt_cap * cfg.rc.hbt_rc_scale << "\n";
    o << "edcompute_rc_override=" << cfg.edcompute_rc.override_enable << "\n";
    o << "edcompute_rc_hbt_res=" << (cfg.edcompute_rc.override_enable ? cfg.edcompute_rc.hbt_res * cfg.edcompute_rc.hbt_rc_scale : cfg.rc.hbt_res * cfg.rc.hbt_rc_scale) << "\n";
    o << "edcompute_rc_hbt_cap=" << (cfg.edcompute_rc.override_enable ? cfg.edcompute_rc.hbt_cap * cfg.edcompute_rc.hbt_rc_scale : cfg.rc.hbt_cap * cfg.rc.hbt_rc_scale) << "\n";
