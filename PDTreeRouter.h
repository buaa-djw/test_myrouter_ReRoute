...
struct RerouteInfo
{
    ...
    int old_hbt_id = -1;
    int new_hbt_id = -1;
    int inserted_hbt_id = -1;
    int removed_hbt_id = -1;
    std::vector<int> old_hbt_ids;
    std::vector<int> new_hbt_ids;
    std::vector<int> inserted_hbt_ids;
    std::vector<int> removed_hbt_ids;
    int changed_hbt_id_count = 0;
    int changed_hbt_count_delta = 0;
    ...
    double max_delay_before = 0.0;
    double max_delay_after = 0.0;
    double avg_delay_before = 0.0;
    double avg_delay_after = 0.0;
    double wirelength_before = 0.0;
    double wirelength_after = 0.0;
    double hbt_delay_before = 0.0;
    double hbt_delay_after = 0.0;
