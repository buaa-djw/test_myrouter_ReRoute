...
int main(int argc, char** argv)
{
    ...
    if (cfg.reroute.enable) {
        ...
        rr_params.enable_2d_optimization = cfg.reroute.enable_2d_optimization;
        rr_params.enable_3d_optimization = cfg.reroute.enable_3d_optimization;
        rr_params.enable_2d_reattach = cfg.reroute.enable_2d_reattach;
        rr_params.enable_2d_ripup = cfg.reroute.enable_2d_ripup;
        rr_params.enable_3d_cross_layer_detour = cfg.reroute.enable_3d_cross_layer_detour;
        rr_params.enable_3d_hbt_replace = cfg.reroute.enable_3d_hbt_replace;
        rr_params.enable_3d_hbt_parent_change = cfg.reroute.enable_3d_hbt_parent_change;
        rr_params.enable_3d_hbt_child_change = cfg.reroute.enable_3d_hbt_child_change;
        rr_params.enable_3d_intra_die_optimization = cfg.reroute.enable_3d_intra_die_optimization;
        rr_params.debug_force_accept = cfg.reroute.debug_force_accept;
        rr_params.debug_force_accept_limit = cfg.reroute.debug_force_accept_limit;
        ...
        rr_params.objective_weight_wirelength = cfg.reroute.objective_weight_wirelength;
