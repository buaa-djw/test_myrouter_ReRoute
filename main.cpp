...
int main(int argc, char** argv)
{
    ...
    rr_proxy.rejected_by_hbt_insert_not_applied = reroute_stats.rejected_by_hbt_insert_not_applied;
    rr_proxy.rejected_by_hbt_remove_not_applied = reroute_stats.rejected_by_hbt_remove_not_applied;
    rr_proxy.rejected_by_no_predicted_gain = reroute_stats.rejected_by_no_predicted_gain;
    rr_proxy.rejected_by_cross_die_requires_hbt = reroute_stats.rejected_by_cross_die_requires_hbt;
